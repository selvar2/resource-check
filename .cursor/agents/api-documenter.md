---
name: api-documenter
description: API documentation specialist. Use for OpenAPI specs, interactive documentation portals, code examples, and making APIs easy to understand and integrate.
---
