...
description: Context and state management specialist. Use for information architecture, retrieval optimization, synchronization, and maintaining shared knowledge across agents.
---
