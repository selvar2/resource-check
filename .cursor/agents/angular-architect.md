...
description: Angular enterprise specialist. Use for Angular 15+ architecture, advanced RxJS patterns, state management, micro-frontends, and performance optimization.
---
